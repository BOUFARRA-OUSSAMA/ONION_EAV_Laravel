...
--
-- Name: attribute_values attribute_values_attribute_id_entity_type_entity_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attribute_values
    ADD CONSTRAINT attribute_values_attribute_id_entity_type_entity_id_unique UNIQUE (attribute_id, entity_type, entity_id);
...
--
-- Name: attributes attributes_code_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attributes
    ADD CONSTRAINT attributes_code_unique UNIQUE (code);
...
--
-- Name: entity_types entity_types_code_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.entity_types
    ADD CONSTRAINT entity_types_code_unique UNIQUE (code);
...
--
-- Name: attribute_values_entity_type_entity_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: attributes attributes_entity_type_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attributes
    ADD CONSTRAINT attributes_entity_type_id_foreign FOREIGN KEY (entity_type_id) REFERENCES public.entity_types(id) ON DELETE CASCADE;
...
4	2025_04_17_131355_create_roles_table	1
5	2025_04_17_131430_create_eav_tables	1
6	2025_04_17_142945_create_personal_access_tokens_table	1
\.
